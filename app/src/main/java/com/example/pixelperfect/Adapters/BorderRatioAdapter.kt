 ...
 * 边框
 */
class BorderRatioAdapter(private val context: Context, var backgroundInstaListener: BackgroundBorderListener) : RecyclerView.Adapter<BorderRatioAdapter.ViewHolder>() {
    var selectedSquareIndex = 0
    var squareViews: MutableList<SquareView?> = mutableListOf()

    interface BackgroundBorderListener {
        fun onBackgroundBorderSelected(i: Int, squareView: SquareView?)
    }
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener {
        ...
        override fun onClick(view: View) {
            ...
            backgroundInstaListener.onBackgroundBorderSelected(selectedSquareIndex, squareViews[selectedSquareIndex])
